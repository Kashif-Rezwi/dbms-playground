# ROADMAP — The Complete 30-Day Progression
...
| | 19 | Keys, constraints & schema design | **P4: E-commerce Analytics** |
| | 20 | Normalization (1NF→3NF) + denormalization | |
| **5 — Tx + Performance** | 21 | Transactions & ACID | **P5: Bank Transfer Simulation** |
| | 22 | Indexes — concept, cost & trade-offs | |
| | 23 | EXPLAIN & query plans | |
| | 24 | Optimization patterns | **P6: Query Performance Lab** |
...
| | 29–30 | **CAPSTONE: real-world system design + build** | **Final Capstone** |
...
| | 07 | UNIQUE, CHECK, NOT NULL, defaults | **P1: Task Manager the PostgreSQL Way** |
| **3 — PG Features** | 08 | Views + materialized views | |
| | 09 | Functions | |
| | 10 | Stored procedures + triggers | **P2: SaaS Task Tracker (triggers)** |
...
| | 29–30 | **CAPSTONE: design + build a real system** | **Final Capstone** |
